...
QBCore.Functions.CreateCallback("RL-multijob:getJobs",function(source, cb)
...
RegisterNetEvent("RL-multijob:changeJob",function(cjob, cgrade)
    local source = source
    local Player = QBCore.Functions.GetPlayer(source)
...
RegisterNetEvent("RL-multijob:removeJob",function(job, grade)
    local source = source
    local Player = QBCore.Functions.GetPlayer(source)
